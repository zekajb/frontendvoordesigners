...
var names = ["Wolfgang Amadeus Mozart", "Ludwig van Beethoven", "Frédérik Chopin", "Johannes Brams", " Johan Sebastiaan Bach", "Berat Zekaj"];
...
for (var i = 0; i < toetsen.length; i++) {
    toetsen[i].addEventListener('click',  function(e) {
        this.classList.toggle('schaduw')
    })
 ...
 window.setTimeout(function() {
  alert('Start Playing Piano And Feel Like A Pianist');
}, 500);